...
void mgfas5new( double **u, int n, int maxcyc, double m,int b, int  *qq, double *x, double *y, double R0, double K, double H)
{
	...
	rjac=/*0.99555*//*0.999*//*0.167080002*//*0.5*/0.8/*0.9 for hyperbolic  K=0~0.6, R=1;0.9 for 33,65; 0.99for 129; 0.9999 for 257*//*0.9 for radial K=0.4~; 0,8 for radial K=0.3*//*0.7 98.438577;0.4 127.339785; 0.3 109.599001;0.2 122.633649; 0.8 98.824411 ; 0.9 172.809778; 0.6 124.435110; 0.75 108.528159; 0.85 106.751849*/;
